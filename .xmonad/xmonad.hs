...
myTabTheme = def { fontName            = "xft:Noto Sans:size=10:style=Bold"
                 , activeColor         = "#46d9ff"
...
myLayoutHook = spacingRaw True (Border 0 5 5 5) True (Border 5 5 5 5) True $ gaps [(U,35), (D,5), (R,5), (L,5)]
               ...
               $ smartBorders
               $ windowNavigation
               $ subLayout [] (tabbed shrinkText myTabTheme)
               $ tiled ||| Grid ||| spiral (6/7) ||| ThreeColMid 1 (3/100) (1/2) ||| noBorders Full ||| tabbed shrinkText myTabTheme 
                    where
...
myXPConfig =
    XPC { font              = "xft:Noto Sans:size=10:style=Bold"
        , bgColor           = "#000000"
        , fgColor           = "#DDDDDD"
        , bgHLight          = "#333333"
        , fgHLight          = "#FFFFFF"
...
--    viewShift    = doF . liftM2 (.) W.greedyView W.shift
    ...
    myTFloats = ["Downloads", "Save As...", "Bluetooth"]
    myRFloats = []
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_l), spawn $ "betterlockscreen -l dim -- --timestr='%H:%M'")
  , ((modMask, xK_d), decWindowSpacing 4)
  , ((modMask, xK_i), incWindowSpacing 5)
  , ((modMask .|. controlMask, xK_d), decScreenSpacing 5)
  , ((modMask .|. controlMask, xK_i), incScreenSpacing 5)
  ...
  , ((controlMask .|. shiftMask , xK_a ), spawn "/home/khoa/scripts/switchinput/switch.sh")
  -- CONTROL + ALT KEYS
...
--  , ((0, xF86XK_AudioStop), spawn $ "mpc stop")
  ...
  , ((controlMask .|. mod1Mask .|. shiftMask, xK_p), sendMessage (MT.Toggle NBFULL) >> sendMessage ToggleStruts)
...
main = do
        ...
        , ppTitle = xmobarColor "#b3afc2" "" . (\ x -> "<fn=1>" ++ x ++ "</fn>") 
        , ppCurrent = xmobarColor "#b3afc2" "" . shorten 60   
